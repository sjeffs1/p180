...
function render_elements() {
    $.ajax({ url: `https://api.openweathermap.org/data/2.5/weather?lat-${coordinates.destination_lat}&lon=${coordinates.destination_lon}&appid=94212e971d0ca977303f8ae892224bbd`,
    type: "get",
